...
//    public static final String BASE_URL_UPLOAD_IMAGE = "http://api.swachh.city/sbm/v1/" + URLData.FILE;
  ...
  public static final String ALL_COMPLAINTS = "complaints/allComplaints"; //9743611241
  ...
  public static HashMap<String, String> getHeaders(final Activity activity, final int headerType) {
    ...
    if (headerType == WebserviceHelper.HEADER_TYPE_NORMAL) {
      String token = "Bearer " + ICMyCPreferenceData
          .getPreferenceItem(activity, ICMyCPreferenceData.token, "");
  ...
  public static HashMap<String, String> getHeadersSwachhManch(final Activity activity,
...
//        token = "Bearer 1167303F-A8D9-0248-C9EF-130090242980"; //qa
    final HashMap<String, String> headers = new HashMap<String, String>();
    if (token != null) {
      headers.put("Accept-Language", ICMyCPreferenceData
          .getPreferenceItem(activity, ICMyCPreferenceData.selectedLanguage, "en"));
    }
...
//            headers.put("Accept", URLData.CONTENT_TYPE);
      ...
      if (ICMyCPreferenceData.getPreferenceItem(activity, ICMyCPreferenceData.token, "").trim()
          .length() > 0) {
        headers.put("Authorization", token);
      }
  ...
  public static HashMap<String, String> getPublicToiletHeaders(final Activity activity) {
    String token =
        "Bearer " + ICMyCPreferenceData.getPreferenceItem(activity, ICMyCPreferenceData.token, "");
    final HashMap<String, String> headers = new HashMap<String, String>();
