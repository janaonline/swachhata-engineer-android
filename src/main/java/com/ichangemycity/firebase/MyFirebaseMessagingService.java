...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() != null) {
            ...
            if(map == null){
                map =  remoteMessage.getData().get("message");
    ...
    private void handleNotification(String message1) {
        ...
        try {
            ...
            if (redirect_to.equalsIgnoreCase("Detail")) {
                ...
                ICMyCPreferenceData.setPreference(this, ICMyCPreferenceData.isResolved, message.toLowerCase().contains("resolve")
                        ? "1" : "0");
                AppController.selectedComplaintData.setComplaintId(subject_id);
...
//                }
     ...
     */
    private void showNotificationMessageWithBigImage(Context context, String title, String message, String timeStamp, Intent intent, String
            imageUrl) {
        notificationUtils = new NotificationUtils(context);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
