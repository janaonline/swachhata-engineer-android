...
public class MainActivity extends AppCompatActivity
  ...
  private void setPropertyForNavItemCount() {
    ...
    high_priority.setText(
        SecurePrefManager.with(activity).get(ICMyCPreferenceData.high_priority_count)
            .defaultValue("0").go());
    ...
    on_the_job.setText(
        SecurePrefManager.with(activity).get(ICMyCPreferenceData.on_the_job_count).defaultValue("0")
            .go());
    ...
    resolved.setText(
        SecurePrefManager.with(activity).get(ICMyCPreferenceData.resolved_count).defaultValue("0")
            .go());
    ...
    rejected.setText(
        SecurePrefManager.with(activity).get(ICMyCPreferenceData.rejected_count).defaultValue("0")
            .go());
    ...
    re_opened.setText(
        SecurePrefManager.with(activity).get(ICMyCPreferenceData.re_opened_count).defaultValue("0")
            .go());
